{{meta}}
        <link rel="stylesheet" type="text/css" href="/css/login-resp.css" />
...
@media only screen and (min-width: 768px) {
    #main {width: 60%;}
    #mainn {width: 30%;}
    #side {width: 35%; display: block;}
    #search-media {visibility: hidden;}
}

        </style>
		<title>Labrador || Login</title>
{{header}}
		...
		<div id="main" style="width: 100%;">
    		...
    		<div id="mainn" style="height: auto; border: 3px solid #00182B; margin: auto; border-radius: 25px; box-shadow: 0px 0px 14px #00182B;">
			    ...
			    <div style="width: 80%; height: auto; margin: auto;">
				    <form action="/cookie" method="post" enctype="multipart/form-data">
					    <input name = "username" placeholder="Username" type="text" style="outline: none; width: 100%; height: 30px; border: 1px solid #00182B; border-radius: 20px; margin: auto; margin-bottom: 20px; padding-left: 10px;" />
			            <input type="password" name="password" placeholder="Password" type="text" style="outline: none; width: 100%; height: 30px; border: 1px solid #00182B; border-radius: 20px; margin: auto; margin-bottom: 20px; padding-left: 10px;" />
